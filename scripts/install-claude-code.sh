...
ASSET_URL="https://github.com/${REPO}/releases/latest/download/bearded-theme-ports-claude-code.zip"
TARGET_DIR="$HOME/.claude/themes"
TMP_DIR="$(mktemp -d)"
ARCHIVE_PATH="$TMP_DIR/bearded-theme-ports-claude-code.zip"
...
printf 'Installed Claude Code themes into %s\n' "$TARGET_DIR"
