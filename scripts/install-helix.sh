...
ASSET_URL="https://github.com/${REPO}/releases/latest/download/bearded-theme-ports-helix.zip"
TARGET_DIR="${XDG_CONFIG_HOME:-$HOME/.config}/helix/themes"
TMP_DIR="$(mktemp -d)"
ARCHIVE_PATH="$TMP_DIR/bearded-theme-ports-helix.zip"
...
printf 'Installed Helix themes into %s\n' "$TARGET_DIR"
